...
namespace AGCSECON.Web
{
    ...
    [EnableClientAccess()]
    public class ActiveGanttXMLService : DomainService
    {

        private string mp_GetPath()
        {
            return HttpContext.Current.Request.MapPath(HttpContext.Current.Request.ApplicationPath) + "\\XML\\";
        }
        ...
        [Invoke()]
        public void SetXML(string sXML, string sFileName)
        {
            Globals.g_WriteFile(mp_GetPath() + sFileName, sXML, System.Text.Encoding.UTF8);
        }
